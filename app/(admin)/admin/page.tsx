...
import { Package, ShoppingBag, Users, DollarSign, TrendingUp, RefreshCw, Image as ImageIcon, ArrowUpRight, ArrowDownRight, Clock, CheckCircle2, Truck, AlertCircle, BarChart3, Activity, Calendar } from 'lucide-react';
    ...
    const fetchStats = async () => {
      ...
      try {
        ...
        const [
          ...
          databases.listDocuments(DATABASE_ID, ORDERS_TABLE_ID, [Query.orderDesc('$createdAt'), Query.limit(5)]),
          ...
          items.forEach((item: string) => {
            ...
            if (!productCounts[productId]) {
              productCounts[productId] = { 
                count: 0, 
                revenue: 0, 
                name: productLookup[productId] || `Product ${productId.slice(0, 8)}` 
              };
            }
          ...
          <Card className="hover:shadow-lg transition-shadow">
            <CardContent className="p-6">
              ...
              <div className="flex items-center text-sm">
                ...
                <span className="text-gray-600">{stats.deliveredOrders} delivered</span>
              </div>
            </CardContent>
          </Card>
          ...
          <Card className="hover:shadow-lg transition-shadow">
            <CardContent className="p-6">
              ...
              <div className="flex items-center text-sm">
                ...
                <span className="text-gray-600">{stats.availableProducts} available</span>
              </div>
            </CardContent>
          </Card>
          ...
          <CardContent>
            <div className="grid grid-cols-1 md:grid-cols-4 gap-4">
              ...
              <div className="flex items-center gap-3 p-4 bg-blue-50 rounded-lg border border-blue-200">
                ...
                <div>
                  <p className="text-2xl font-bold text-blue-900">{stats.acceptedOrders}</p>
              ...
              <div className="flex items-center gap-3 p-4 bg-purple-50 rounded-lg border border-purple-200">
                ...
                <div>
                  <p className="text-2xl font-bold text-purple-900">{stats.outForDeliveryOrders}</p>
                    ...
                    <div key={product.id} className="flex items-center justify-between p-3 bg-gray-50 rounded-lg hover:bg-gray-100 transition-colors">
                      <div className="flex items-center gap-3">
                        ...
                        <div>
                          ...
                          <p className="text-xs text-gray-500">{product.count} kg sold</p>
                        </div>
                      </div>
                      <div className="text-right">
