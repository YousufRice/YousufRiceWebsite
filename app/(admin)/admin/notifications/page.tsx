...
export default function AdminNotificationsPage() {
  ...
  const [analyticsCampaign, setAnalyticsCampaign] =
    ...
    try {
      ...
      const [campaignsResult, subscriptionsRes] = await Promise.all([
        ...
        fetch(`/api/push/stats`)
          .then((r) => r.json())
          .catch(() => ({ totalSubscriptions: 0 })),
      ]);

      const allCampaigns = campaignsResult.success
        ? (campaignsResult.campaigns as unknown as NotificationCampaign[])
        : [];
  ...
  const handleEdit = (campaign: NotificationCampaign) => {
    ...
    setFormData({
      ...
      target_tags: Array.isArray(campaign.target_tags)
  ...
  const handleSendCampaign = async (campaign: NotificationCampaign) => {
    ...
    try {
      const data = await sendCampaign(campaign.$id);
                ...
                <CardContent className="p-4">
                  <div className="flex flex-col md:flex-row gap-4">
                    ...
                    <Select
                      value={filterStatus}
                      onValueChange={(v) =>
                        setFilterStatus(v as CampaignStatus | "all")
                      }
                    >
                    ...
                    <form onSubmit={handleSubmit} className="space-y-4">
                        ...
                        <div className="space-y-4">
                          ...
                          <div>
                            ...
                            <Input
                              ...
                              placeholder="promotion, order, general"
                            />
                          </div>
                          <div>
                            <label className="block text-sm font-medium text-gray-700 mb-1">
                            ...
                            <Select
                              ...
                              onValueChange={(v: string) =>
                                setFormData({
                                  ...formData,
                                  campaign_type: v as CampaignType,
                                })
                              }
                            >
                              <SelectTrigger>
                      ...
                      <div className="grid md:grid-cols-3 gap-4">
                        <div>
                          ...
                          <Select
                            ...
                            onValueChange={(v) =>
                              setFormData({
                                ...formData,
                                target_segment: v as TargetSegment,
                              })
                            }
                          >
                            <SelectTrigger>
                        ...
                        <div>
                          ...
                          <Input
                            ...
                            placeholder="promotions, orders, deals"
                          />
                        </div>
                        <div>
                          <label className="block text-sm font-medium text-gray-700 mb-1">
                      ...
                      <div className="flex items-center space-x-2">
                        <input
                          ...
                          onChange={(e) =>
                            setFormData({
                              ...formData,
                              require_interaction: e.target.checked,
                            })
                          }
                          className="w-4 h-4 text-blue-600 rounded"
                        />
                        <label
                          htmlFor="require_interaction"
                          className="text-sm font-medium text-gray-700"
                        >
                          Require user interaction (stays visible until clicked)
                        </label>
                      </div>
                      ...
                      <div className="border border-gray-200 rounded-lg p-4 bg-gray-50">
                        ...
                        <p className="text-xs text-gray-500 mt-2">
                          Upload an image to make your notification more
                          engaging. Recommended: 512x256px.
                        </p>
                      </div>
                      ...
                      {campaigns
                        ...
                        .map((campaign) => {
                          const total =
                            campaign.sent_count + campaign.failed_count;
                          const delivery =
                            total > 0 ? (campaign.sent_count / total) * 100 : 0;
                          const click =
                            campaign.sent_count > 0
                              ...
                              <div className="space-y-2">
                                <div>
                                  <div className="flex justify-between text-xs mb-1">
                                    ...
                                    <span>{Math.round(delivery)}%</span>
                                  </div>
                                  <div className="h-2 bg-gray-100 rounded-full overflow-hidden">
                                    <div
                                      className="h-full bg-green-500 rounded-full transition-all"
                                      style={{ width: `${delivery}%` }}
                                    />
                                  </div>
                                </div>
                                <div>
              ...
              <div className="space-y-4">
                <div className="flex items-start gap-3">
                  {analyticsCampaign.image_url ? (
                    <div className="relative w-16 h-16 rounded-lg overflow-hidden border shrink-0">
                      <Image
                        src={analyticsCampaign.image_url}
                        alt=""
                        fill
                        className="object-cover"
                      />
                  ...
                  <div>
                    <h3 className="font-bold text-lg">
                      {analyticsCampaign.title}
                    </h3>
                    <p className="text-sm text-gray-500 line-clamp-2">
                      {analyticsCampaign.body}
                    </p>
                    <div className="flex gap-2 mt-1">
                      {getStatusBadge(analyticsCampaign.status)}
                      <Badge variant="outline">
                        {analyticsCampaign.campaign_type}
                      </Badge>
                    </div>
                  </div>
                </div>
                ...
                <div className="grid grid-cols-2 gap-3">
                  <div className="bg-gray-50 rounded-lg p-3 text-center">
                    <p className="text-2xl font-bold text-gray-900">
                      {analyticsCampaign.sent_count}
                    </p>
                    <p className="text-xs text-gray-500">Sent</p>
                  </div>
                  <div className="bg-gray-50 rounded-lg p-3 text-center">
                    <p className="text-2xl font-bold text-green-600">
                      {analyticsCampaign.delivered_count}
                    </p>
                    <p className="text-xs text-gray-500">Delivered</p>
                  </div>
                  <div className="bg-gray-50 rounded-lg p-3 text-center">
                    <p className="text-2xl font-bold text-blue-600">
                      {analyticsCampaign.clicked_count}
                    </p>
                    <p className="text-xs text-gray-500">Clicks</p>
                  </div>
                  <div className="bg-gray-50 rounded-lg p-3 text-center">
                    <p className="text-2xl font-bold text-red-600">
                      {analyticsCampaign.failed_count}
                    </p>
                ...
                {analyticsCampaign.sent_at && (
                  <p className="text-sm text-gray-500">
                    Sent on{" "}
                    {new Date(analyticsCampaign.sent_at).toLocaleString()}
                  </p>
                )}
              </div>
            )}
