  ...
  return (
    <div className="min-h-screen bg-linear-to-b from-gray-50 to-white">
      <div className="max-w-7xl mx-auto px-3 sm:px-4 md:px-6 lg:px-8 py-4 sm:py-6 md:py-8">
        <Link href="/#products" className="inline-flex items-center text-[#27247b] hover:text-[#27247b]/80 mb-4 sm:mb-6 font-semibold transition-colors group">
            ...
            {imageUrls.length > 0 ? (
              ...
              <div className="w-full h-full flex items-center justify-center">
                <div className="text-center">
                  ...
                  <p className="text-base sm:text-lg text-gray-600 font-medium">No Images Available</p>
                </div>
              </div>
            )}
          </div>
          ...
          <div className="bg-linear-to-br from-white via-white to-[#ffff03]/5 rounded-lg sm:rounded-xl shadow-lg p-3 sm:p-4 md:p-5 border-2 border-[#ffff03]/20 hover:border-[#ffff03]/50 transition-all duration-300">
            ...
            {!product.available && (
              <div className="bg-linear-to-r from-red-100 to-red-50 border-2 border-red-400 text-red-800 px-3 sm:px-4 py-2 sm:py-3 rounded-lg sm:rounded-xl mb-3 sm:mb-4 flex items-center shadow-md">
                <span className="font-bold text-xs sm:text-sm">⚠️ Currently Out of Stock - Check Back Soon!</span>
              </div>
            )}

            {product.description && (
              <div className="mt-3 p-2 sm:p-3 md:p-4 bg-linear-to-r from-[#27247b]/5 to-transparent rounded-lg border-l-4 border-[#ffff03]">
                <h3 className="text-xs font-bold text-[#27247b] mb-2 uppercase tracking-wide">About This Product</h3>
              ...
              <div className="flex items-start justify-between gap-2 sm:gap-3 mb-3">
                <div className="flex-1 min-w-0">
                  <h3 className="text-base sm:text-lg font-bold bg-linear-to-r from-[#27247b] to-[#1a1854] bg-clip-text text-transparent flex items-center gap-2">
                    ...
                    <span className="wrap-break-word">Choose Your Quantity</span>
                  </h3>
                  <p className="text-xs sm:text-sm text-gray-600 mt-1">Select bag sizes · Special bulk discounts available</p>
                </div>
                {totalKg > 0 && (
              ...
              <div className="group flex items-center justify-between bg-linear-to-r from-white to-gray-50 p-2 sm:p-3 rounded-lg border-2 border-gray-200 hover:border-[#27247b] hover:shadow-md transition-all duration-300">
                <div className="flex items-center gap-2 min-w-0">
                  ...
                  <div className="min-w-0">
                    <p className="font-bold text-[#27247b] text-xs sm:text-sm md:text-base truncate">1kg Bag</p>
                    <p className="text-xs text-gray-600 font-medium">{formatCurrency(getPricePerKg(product, 1))}/kg</p>
                  </div>
                </div>
                <div className="flex items-center gap-1 sm:gap-2 shrink-0">
                  ...
                  <span className="w-5 sm:w-6 text-center font-bold text-[#27247b] text-sm">{bagCounts.kg1}</span>
                  <Button
                    size="sm"
                    variant="outline"
              ...
              <div className="group flex items-center justify-between bg-linear-to-r from-white to-gray-50 p-2 sm:p-3 rounded-lg border-2 border-gray-200 hover:border-[#27247b] hover:shadow-md transition-all duration-300">
                <div className="flex items-center gap-2 min-w-0">
                  ...
                  <div className="min-w-0">
                    ...
                    <p className="text-xs text-gray-600 font-medium">{formatCurrency(getPricePerKg(product, 5))}/kg</p>
                  </div>
                </div>
                <div className="flex items-center gap-1 sm:gap-2 shrink-0">
                  <Button
                  ...
                  <span className="w-5 sm:w-6 text-center font-bold text-[#27247b] text-sm">{bagCounts.kg5}</span>
                  <Button
                    size="sm"
                    variant="outline"
              ...
              <div className="group flex items-center justify-between bg-linear-to-r from-white to-blue-50 p-2 sm:p-3 rounded-lg border-2 border-blue-200 hover:border-blue-400 hover:shadow-md transition-all duration-300">
                <div className="flex items-center gap-2 min-w-0">
                  ...
                  <div className="min-w-0">
                    ...
                    <p className="text-xs text-gray-600 font-medium">{formatCurrency(getPricePerKg(product, 10))}/kg</p>
                  </div>
                </div>
                <div className="flex items-center gap-1 sm:gap-2 shrink-0">
                  <Button
                  ...
                  <span className="w-5 sm:w-6 text-center font-bold text-[#27247b] text-sm">{bagCounts.kg10}</span>
                  <Button
                    size="sm"
                    variant="outline"
              ...
              <div className="group flex items-center justify-between bg-linear-to-r from-[#ffff03]/20 via-[#ffff03]/10 to-white p-2 sm:p-3 rounded-lg border-2 border-[#ffff03] hover:border-[#ffd700] hover:shadow-lg transition-all duration-300 relative overflow-hidden">
                ...
                <div className="flex items-center gap-2 min-w-0 relative z-10">
                  ...
                  <div className="min-w-0">
                    ...
                    <p className="text-xs text-gray-700 font-bold">{formatCurrency(getPricePerKg(product, 25))}/kg</p>
                  </div>
                </div>
                <div className="flex items-center gap-1 sm:gap-2 relative z-10 shrink-0">
                  ...
                  <span className="w-5 sm:w-6 text-center font-bold text-[#27247b] text-sm">{bagCounts.kg25}</span>
                  <Button
                    size="sm"
                    variant="outline"
              ...
              <div className="mt-3 sm:mt-4 bg-linear-to-r from-[#27247b] to-[#1a1854] rounded-lg p-3 sm:p-4 shadow-lg">
                <div className="flex items-center justify-between gap-4">
                  <div className="min-w-0">
                    ...
                    <p className="text-xl sm:text-2xl font-bold text-[#ffff03]">{formatCurrency(totalPrice)}</p>
                  </div>
                  <div className="text-right shrink-0">
                    <p className="text-white/80 text-xs sm:text-sm mb-1">Price per kg</p>
                    <p className="text-lg sm:text-xl font-bold text-white">{formatCurrency(pricePerKg)}</p>
                  </div>
                </div>
              </div>
            )}
