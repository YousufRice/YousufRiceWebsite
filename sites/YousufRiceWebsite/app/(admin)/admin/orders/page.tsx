...
import { Clock, Package, Truck, CheckCircle, ExternalLink, Search, Filter, Download, Calendar, DollarSign, ShoppingBag, TrendingUp, CheckCircle2 } from 'lucide-react';
                  ...
                  <div>
                    ...
                    <Badge 
                      variant={
                        ...
                        order.status === 'out_for_delivery' ? 'purple' :
                        'success'
                      }
                      className="mt-2"
                    >
