  ...
  try {
    ...
    try {
      ...
      if (error.code === 409) {
        ...
        console.error(
          "❌ Error creating Product Images bucket:",
          error.message
        );
      }
    }
    ...
    console.log(
      "- Tables: 7 (Products, Product Images, Customers, Orders, Addresses, Sessions, Mill Images)"
    );
...
if (require.main === module) {
  ...
  if (config.apiKey === "YOUR_API_KEY_HERE") {
    ...
    console.log(
      '2. Replace "YOUR_API_KEY_HERE" with your actual Appwrite API key'
    );
